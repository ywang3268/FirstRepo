...
vcf_path = '/Users/eva/Desktop/Python/YHPedigree_Class.vcf'    # modify this line if needed to match your file location
...
print("Painted array shapes:")
print("Paternal:", paternally_painted.shape)
print("Maternal:", maternally_painted.shape)
print("Phase mask shapes:")
...
fig.tight_layout()
fig.savefig('/Users/eva/Desktop/Python/assignment3_visualization.pdf')
plt.close(fig)
